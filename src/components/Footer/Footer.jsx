      ...
      <div className='footer_container'>
        ...
        <div className='fotter_bottom_left'>
            <div className='footer_contact'>
              ...
              <div className='support-line-wrapper'>
                <div className='support_line'>
                <span style={{fontSize:'1.2rem'}}>Support Line:</span>
                <span style={{marginLeft:'1rem', color:'#00a7ac', fontSize:'1.2rem', fontWeight:'500'}}>+233 599678566</span>
                </div>
                
                <div className='footer_right_top2'>
            ...
            <div className='copyright_footer'>
              <span>©Copyright 2023 <span style={{color:'#00a7ac', fontWeight:'500', Border:'2px solid'}}>Inserviz Inc</span>{" "}</span>
          ...
          <div className='footer_right'>
            ...
            <div className='copyright_footer2'>
              <span>©Copyright 2023 <span style={{color:'#00a7ac', fontWeight:'500', Border:'2px solid'}}>Inserviz Inc</span>{" "}</span>
              <span>Design By <span style={{color:'#00a7ac', fontWeight:'500'}}>Inserviz Team</span></span>
            </div>
